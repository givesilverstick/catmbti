export const QuestionData = [
    ...
    {
        id: 3,
        title: "아무리 봐도 우리 고양이가 정말 이쁜 것 같다. 나의 행동은?",
        answera: "'하즈 너무 이쁜 것 같아.. 사람들한테 자랑해야지..!!'하며 인스타를 만들어서 사진도 공유하고 소통도 한다.",
    ...
    },
    {
        ...
        answera: "손, 눈 대중으로 '대충 이 정도면 되겠지' 하고 급여한다.",
    ...
    },
    {
        ...
        answera: "'이건 어떻게 하면 어떨까?' 해결책을 함께 생각하며 정보들을 같이 찾아본다.",
