...
import Ameshort from '../cat/ameshort.jpg';
...
import Mainecoon from '../cat/mainecoon.jpg';
...
export const ResultData = [
    {
        ...
        name: '러시안 블루',
        best: 'ESTJ', 
        desc: '겁이 많아요. 워낙 온수난 성격에 조용한 고양이라 소심하게 느껴집니다! 낯을 심하게 가리는 편이구요. 혼자 놔두면 호기심이 많아서 이것저것 치고 건드리고 즐겁게 보내는 고양이입니다. 초보 애묘가가 키우기 좋은 묘종입니다.',
        image: `${RussianBlue}`,
    },
    {
        id: 2,
    ...
    },
    {
        ...
        name: '페르시안',
        best: 'ENTJ', 
        desc: '조용하고 성격도 순한편이어서 개냥이가 되는 경우가 많습니다. 장모종이어서 털이 굉장히 부드러워요. 아이와 함께 키워도 좋을 만큼 굉장히 순하고 독립심이 강한 고양이 입니다.',
        image: `${Persian}`,
    },
    {
        id: 4,
    ...
    },
    {
        ...
        name: '렉돌',
        best: 'ESFJ', 
        desc: '긴 털과 아주 예쁜 외모로 많이 사랑받는 고양이! 봉제인형이라는 이름처럼 집사가 안으면 인형처럼 안겨있는 고양이입니다! 너무나도 순하고 집사와의 교감을 매우 좋아하는 고양이 중에 하나입니다!',
        image: `${Ragdoll}`,
    },
    {
        id: 14,
